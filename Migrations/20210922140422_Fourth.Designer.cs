...
namespace Apontamento.Migrations
{
    ...
    [Migration("20210922140422_Fourth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apontamento.Models.Usuario", b =>
                {
                    ...
                    b.Property<int?>("TabelaControleId")
                        .HasColumnType("int");

                    b.HasKey("UsuarioID");

                    b.HasIndex("TabelaControleId");
            ...
            modelBuilder.Entity("Apontamento.Models.Usuario", b =>
                {
                    b.HasOne("Apontamento.Models.TabelaControle", "TabelaControle")
                        .WithMany()
                        .HasForeignKey("TabelaControleId");

                    b.Navigation("TabelaControle");
                });
